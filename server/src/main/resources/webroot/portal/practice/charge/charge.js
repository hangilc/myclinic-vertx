...
let tmpl = `
<div class="mt-2 charge-listener payment-listener no-pay-0410-listener no-pay-list-listener"></div>
`;
...
export class Charge {
    constructor(props){
        ...
        on(this.ele, "no-pay-list-changed", event => {
            this.props.isInNoPayList = app.isInNoPayList(this.props.visitId);
            this.updateUI();
        })
    }
