...
class AppointBook {
    ...
    public void applyPatches(Collection<CovidVaccine.PatchCommand> patches){
        patches.forEach(this::applyPatch);
    }

    public void addStateLog(StateLog stateLog) {
        applyLogEntry(stateLog);
    }
...
//        }
    ...
    public Collection<Patient> listPatient(){
        ensurePatientMap();
